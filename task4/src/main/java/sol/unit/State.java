    ...
    public State(String name, String attributes) throws ParseException {
        if (!attributes.isEmpty()) {
            ...
            for (String attr : allAttributes) {
                ...
                if ("synth".equals(parts[1])) {
                    this.synthesizedAttributes.put(parts[0], new StringAttribute(null));
                    continue;
                }
                if ("inherit".equals(parts[1])) {
                    this.inheritedAttributes.put(parts[0], new StringAttribute(null));
                    continue;
                }
                throw new ParseException("invalid attribute format", 0);
            }
